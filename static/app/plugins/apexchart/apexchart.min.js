    ...
    var C = {
      ...
      , j = function() {
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                e.dom.elGridRect = i.drawRect(-a - o - 2, 2 * -a - 2, e.gridWidth + a + n + o + 4, e.gridHeight + 4 * a + 4, 0, "#fff");
      ...
      , Xt = function(t) {
        for (var e = "", i = 0; i < t.length; i++) {
            ...
            i > 1 && Math.abs(a[r - 2] - s[o - 2]) < 30 ? (e += "Q".concat(a[0], ", ").concat(a[1]),
            e += ", ".concat(a[2], ", ").concat(a[3])) : r > 4 ? (e += "C".concat(a[0], ", ").concat(a[1]),
            e += ", ".concat(a[2], ", ").concat(a[3]),
            e += ", ".concat(a[4], ", ").concat(a[5])) : r > 2 && (e += "S".concat(a[0], ", ").concat(a[1]),
            e += ", ".concat(a[2], ", ").concat(a[3]))
        }
        return e
    }
        ...
        return r(t, [{
            ...
            value: function(t, i, a, s) {
                ...
                for (var d = [], g = 0; g < t.length; g++) {
                    ...
                    o.globals.isXNumeric && o.globals.seriesX.length > 0 && (b = (o.globals.seriesX[u][0] - o.globals.minX) / this.xRatio),
                    x.push(b);
                    var v = b
                      , w = this.zeroY
                      , k = this.zeroY;
                    ...
                    "smooth" === o.config.stroke.curve && null === t[g][0] ? p.push(null) : p.push(w);
                    ...
                    if ("rangeArea" === l) {
                        ...
                        S.linePaths[0] = L.linePath + S.linePath,
                        S.pathFromLine = L.pathFromLine + S.pathFromLine
                    }
                    this._handlePaths({
                        type: l,
                        realIndex: u,
                ...
                "smooth" === w) {
                    ...
                    if (A && S.length > 1) {
                        ...
                        "rangeArea" === e && b) {
                            ...
                            u += y.line(S[S.length - 1][0], k) + y.line(S[0][0], k) + y.move(S[0][0], S[0][1]) + "z";
                        p.push(g),
                        f.push(u)
                    }
                } else {
